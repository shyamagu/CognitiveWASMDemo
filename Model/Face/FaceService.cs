...
public class FaceService {
    ...
    public async Task<IList<DetectedFace>> DetectFaceExtract(IFaceClient client, Stream imageStream, string modelVersion){
        ...
        //ModelVersion=="3"
            ...
            return await client.Face.DetectWithStreamAsync(imageStream,
                returnFaceLandmarks: true,
                returnFaceAttributes: new List<FaceAttributeType> { FaceAttributeType.HeadPose, FaceAttributeType.Mask },
    ...
    public List<string> GetFaceAnalysisResult(DetectedFace face, string modelVersion){
        ...
        if(modelVersion=="3"){
            ...
            faceApiResult.Add($"Mask : {face.FaceAttributes.Mask.NoseAndMouthCovered}");
        }
